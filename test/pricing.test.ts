...
describe("pricing", () => {
  ...
  it("resolves ccusage Claude short aliases and legacy Claude 3 pricing", () => {
    const aliases = [
      ...
      ["claude-sonnet-4-5-20250929-thinking", "3", "15", "0.3", "3.75"],
  ...
  it("resolves ccusage supplemental Grok and Z.ai pricing entries", () => {
    ...
    expect(resolvePricing("xai/grok-code-fast-1-0825")).toMatchObject({
      modelId: "xai/grok-code-fast-1-0825",
      inputUsdPerMillion: "1",
      outputUsdPerMillion: "2",
      cacheReadUsdPerMillion: "0.2",
    ...
    expect(resolvePricing("replicate/openai/gpt-oss-20b")).toMatchObject({
      ...
      cacheCreationUsdPerMillion: "0.1125",
    });
  });
  ...
  it("resolves ccusage models.dev pricing rows updated after v20.0.20", () => {
    ...
    expect(resolvePricing("deepseek-v4-pro-0813")).toMatchObject({
      ...
      cacheCreationUsdPerMillion: "1.6875",
    });
    expect(resolvePricing("deepseek/deepseek-v4-pro")).toMatchObject({
      modelId: "deepseek/deepseek-v4-pro",
      inputUsdPerMillion: "1.215",
      outputUsdPerMillion: "3.645",
      cacheReadUsdPerMillion: "0.0405",
      cacheCreationUsdPerMillion: "1.215",
    });
    expect(resolvePricing("qwen/deepseek-v4-pro-0813")).toMatchObject({
      ...
      cacheCreationUsdPerMillion: "0.825",
    });
    ...
    expect(resolvePricing("Qwen/Qwen3.8-27B-TEE")).toMatchObject({
      ...
      cacheCreationUsdPerMillion: "0.3",
    });
    expect(resolvePricing("Qwen3.8-Flash-Next")).toMatchObject({
    ...
    expect(resolvePricing("MiniMaxAI/MiniMax-M2.5")).toMatchObject({
    ...
    expect(resolvePricing("MiniMaxAI/MiniMax-M3")).toMatchObject({
      modelId: "MiniMaxAI/MiniMax-M3",
      inputUsdPerMillion: "0.6",
      outputUsdPerMillion: "2.4",
      cacheReadUsdPerMillion: "0.12",
      cacheCreationUsdPerMillion: "0.75",
      inputAbove200kUsdPerMillion: "1.2",
      outputAbove200kUsdPerMillion: "4.8",
      cacheReadAbove200kUsdPerMillion: "0.24",
      longContextThresholdTokens: 512_000,
    });
    expect(resolvePricing("-cf/zai-org/glm-5.3")).toMatchObject({
      modelId: "glm-5.3",
    ...
    expect(resolvePricing("~deepseek/deepseek-v4-flash-latest")).toMatchObject({
      ...
      cacheReadUsdPerMillion: "0.016",
      cacheCreationUsdPerMillion: "0.0375",
    });
    ...
    expect(resolvePricing("glm-5.2-fast")).toMatchObject({
      ...
      cacheReadUsdPerMillion: "0.231",
      cacheCreationUsdPerMillion: "2.8875",
    });
    expect(resolvePricing("ionos/openai/gpt-oss-120b")).toMatchObject({
      modelId: "ionos/openai/gpt-oss-120b",
      inputUsdPerMillion: "0.170505",
      outputUsdPerMillion: "0.738855",
      cacheReadUsdPerMillion: "0.0170505",
      cacheCreationUsdPerMillion: "0.21313125",
    });
    expect(resolvePricing("ionos/meta-llama/Llama-3.3-70B-Instruct")).toMatchObject({
      ...
      inputUsdPerMillion: "0.738855",
      outputUsdPerMillion: "0.738855",
      cacheReadUsdPerMillion: "0.0738855",
      cacheCreationUsdPerMillion: "0.92356875",
    });
    expect(resolvePricing("scaleway/deepseek-v4-flash-0731")).toMatchObject({
      modelId: "scaleway/deepseek-v4-flash-0731",
      inputUsdPerMillion: "0.45468",
      outputUsdPerMillion: "0.90936",
      cacheReadUsdPerMillion: "0.090936",
      cacheCreationUsdPerMillion: "0.56835",
    });
    expect(resolvePricing("scaleway/gpt-oss-120b")).toMatchObject({
      modelId: "scaleway/gpt-oss-120b",
      inputUsdPerMillion: "0.170505",
      outputUsdPerMillion: "0.68202",
      cacheReadUsdPerMillion: "0.0170505",
      cacheCreationUsdPerMillion: "0.21313125",
    });
    expect(resolvePricing("scaleway/llama-3.3-70b-instruct")).toMatchObject({
      modelId: "scaleway/llama-3.3-70b-instruct",
      inputUsdPerMillion: "1.02303",
      outputUsdPerMillion: "1.02303",
      cacheReadUsdPerMillion: "0.102303",
      cacheCreationUsdPerMillion: "1.2787875",
    });
    ...
    expect(resolvePricing("deepseek-v4-pro")).toMatchObject({
      ...
      cacheCreationUsdPerMillion: "0.54375",
    });
    ...
    expect(resolvePricing("google/gemini-3.7-flash")).toMatchObject({
      ...
      outputUsdPerMillion: "3.75",
      cacheReadUsdPerMillion: "0.075",
      cacheCreationUsdPerMillion: "0.041667",
    });
  ...
  it("resolves ccusage September 2026 snapshot pricing refresh rows", () => {
    expect(resolvePricing("MiniCPM5-2B")).toMatchObject({
      modelId: "MiniCPM5-2B",
      inputUsdPerMillion: "0.124",
      outputUsdPerMillion: "0.7425",
      cacheReadUsdPerMillion: "0.124",
      cacheCreationUsdPerMillion: "0.155",
    });
    expect(resolvePricing("google/gemini-3.8-flash")).toMatchObject({
    ...
    expect(resolvePricing("vertex/gemini-3.8-flash@eu")).toBeNull();
    expect(resolvePricing("bailian/qwen3.8-max-0902")).toMatchObject({
    ...
    expect(resolvePricing("qwen3-8-max-0902")).toMatchObject({
    ...
    expect(resolvePricing("alibaba/qwen3.8-max-prime")).toMatchObject({
      modelId: "alibaba/qwen3.8-max-prime",
      inputUsdPerMillion: "4",
      outputUsdPerMillion: "12",
      cacheReadUsdPerMillion: "0.5",
      cacheCreationUsdPerMillion: "5",
    });
    expect(resolvePricing("grok-4.7")).toMatchObject({
      modelId: "grok-4.7",
      inputUsdPerMillion: "2",
      outputUsdPerMillion: "6",
      cacheReadUsdPerMillion: "0.5",
    ...
    expect(resolvePricing("gpt-6-astra")).toMatchObject({
      modelId: "gpt-6-astra",
      inputUsdPerMillion: "10",
      outputUsdPerMillion: "50",
      cacheReadUsdPerMillion: "1",
    ...
    expect(resolvePricing("openai-gpt-6-astra")).toBeNull();
    ...
    expect(resolvePricing("deepseek/deepseek-chat-v3.1")).toMatchObject({
      modelId: "deepseek/deepseek-chat-v3.1",
      inputUsdPerMillion: "0.27",
      outputUsdPerMillion: "1",
      cacheReadUsdPerMillion: "0.135",
      cacheCreationUsdPerMillion: "0.3375",
    });
    expect(resolvePricing("deepseek-v4.1-flash")).toMatchObject({
      modelId: "deepseek-v4.1-flash",
      inputUsdPerMillion: "0.31",
      outputUsdPerMillion: "1.23",
      cacheReadUsdPerMillion: "0.01",
      cacheCreationUsdPerMillion: "0.3875",
    });
    expect(resolvePricing("deepseek-v4.1-flash-flex")).toMatchObject({
      modelId: "deepseek-v4.1-flash-flex",
      inputUsdPerMillion: "0.0975",
      outputUsdPerMillion: "0.39",
      cacheReadUsdPerMillion: "0.00975",
      cacheCreationUsdPerMillion: "0.121875",
      exactOnly: true,
    });
    expect(resolvePricing("mimo-v2.6-pro")).toMatchObject({
    ...
    expect(resolvePricing("mimo-v2-6-pro")).toBeNull();
    expect(resolvePricing("step-5-preview")).toMatchObject({
      modelId: "step-5-preview",
      inputUsdPerMillion: "0.959",
      outputUsdPerMillion: "2.741",
      cacheReadUsdPerMillion: "0.048",
      cacheCreationUsdPerMillion: "1.19875",
    });
    expect(resolvePricing("mixedbread/toast-1")).toMatchObject({
      modelId: "mixedbread/toast-1",
      inputUsdPerMillion: "0.3",
      outputUsdPerMillion: "0.72",
      cacheReadUsdPerMillion: "0.036",
      cacheCreationUsdPerMillion: "0.375",
    });
    expect(resolvePricing("openai/gpt-5.6-sol-discounted")).toBeNull();
    expect(resolvePricing("openai/gpt-latest")).toMatchObject({
      modelId: "openai/gpt-latest",
      inputUsdPerMillion: "10",
      outputUsdPerMillion: "50",
    ...
    expect(resolvePricing("azure/gpt-6-sol")).toMatchObject({
      modelId: "azure/gpt-6-sol",
      inputUsdPerMillion: "2",
      outputUsdPerMillion: "10",
      cacheReadUsdPerMillion: "0.2",
      cacheCreationUsdPerMillion: "2.5",
    });
    expect(resolvePricing("aion-labs/aion-3.5")).toMatchObject({
    ...
    expect(resolvePricing("fastino/gliguard-PII-multi")).toMatchObject({
      modelId: "fastino/gliguard-PII-multi",
      inputUsdPerMillion: "0.15",
      outputUsdPerMillion: "0.15",
      cacheReadUsdPerMillion: "0.15",
      cacheCreationUsdPerMillion: "0.15",
      exactOnly: true,
    });
    ...
    expect(resolvePricing("openrouter/deepseek/deepseek-v4-pro-0813")).toMatchObject({
      ...
      inputUsdPerMillion: "0.462",
      outputUsdPerMillion: "1.386",
      cacheReadUsdPerMillion: "0.0154",
      cacheCreationUsdPerMillion: "0.5775",
    });
    ...
    expect(resolvePricing("~z-ai/glm-flash-latest")).toMatchObject({
    ...
    expect(resolvePricing("~z-ai/glm-latest")).toMatchObject({
      ...
      inputUsdPerMillion: "0.5614",
      outputUsdPerMillion: "1.7644",
      cacheReadUsdPerMillion: "0.10426",
      cacheCreationUsdPerMillion: "0.70175",
    });
    ...
    expect(resolvePricing("anthropic/claude-opus-5.5")).toMatchObject({
  ...
  it("resolves ccusage Claude Opus 5 models.dev pricing", () => {
    ...
    withCcusageModelAliases("private-opus-fast=claude-opus-5-fast", () => {
      expect(resolvePricing("private-opus-fast")).toMatchObject({
        modelId: "claude-opus-5-fast",
        inputUsdPerMillion: "10",
      });
    });
  ...
  it("resolves ccusage LiteLLM Gemini Robotics pricing", () => {
    expect(resolvePricing("gemini/gemini-robotics-er-2-preview")).toMatchObject({
      modelId: "gemini/gemini-robotics-er-2-preview",
      inputUsdPerMillion: "1",
      outputUsdPerMillion: "5",
      cacheReadUsdPerMillion: "0.1",
      cacheCreationUsdPerMillion: "1.25",
